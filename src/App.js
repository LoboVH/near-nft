...
const App = ({ currentUser, nearConfig, walletConnection }) => {
  ...
  const handleAuctionChange = async () => {
    ...
    console.log("auction nfts", saleTokens);
  };
  ...
  const loadSaleItems = async () => {
    ...
    console.log("contract name:", nearConfig.contractName);
    console.log("market", nearConfig.marketContractName);
    let saleTokens = await walletConnection
      .account()
      .viewFunction(
        nearConfig.marketContractName,
  ...
  const sendStorageDeposit = async () => {
    ...
    //await getMinimumStorage();
    console.log("minimum balance", minimum);
              ...
              <article className="card-wrapper">
                <a className="asset-anchor" href="#">
                  ...
                  <div className="sell-wrapper">
                    ...
                    <button className="form-btn" onClick={handleAuctionChange}>
                      auction nfts
                    </button>
                  </div>
                </a>
